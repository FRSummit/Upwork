  ...
  <div>
    <v-card class="elevation-12 v-card-edit">
      <v-toolbar color="primary" dark flat>
        <v-spacer />
        <v-toolbar-title>Update Post 4</v-toolbar-title>
        <v-spacer />
      </v-toolbar>
      <v-card-text class="v-card-text">
        <v-form @submit.prevent="onSubmit">
          ...
          <div class="name-field">
            <label class="field-label">Image 1 Details 1</label>
            <v-text-field class="field-input" v-model="img1_desc2" id="img1_desc2" placeholder="Description" type="text"/>
          </div>
          <!-- img 2 -->
          <div class="name-field">
            <label class="field-label" style="width: 30%">Upload another image:</label>
            <input class="field-input" @change="previewImage2" id="img2" type="file" accept="image/*" style="width: 30%"/>
            <div style="display: inline-block;">
                <p>Progress: {{uploadValue2.toFixed()+"%"}}
            ...
            <div v-if="imageData2!=null">
                ...
                <br>
            <button @click="onUpload2" class="img-up-btn">Upload</button>
            </div>
          </div>
          <div class="name-field">
            <label class="field-label">Image 2 Details 1</label>
            <v-text-field class="field-input" v-model="img2_desc1" id="img2_desc1" placeholder="Description" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Image 2 Details 2</label>
            <v-text-field class="field-input" v-model="img2_desc2" id="img2_desc2" placeholder="Description" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Subtitle 1</label>
            <v-text-field class="field-input" v-model="subtitle1" id="subtitle1" placeholder="Subtitle 1" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Subtitle Text 1</label>
            <v-text-field class="field-input" v-model="subtitleText1" id="subtitleText1" placeholder="Subtitle text 1" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Subtitle Text 2</label>
            <v-text-field class="field-input" v-model="subtitleText2" id="subtitleText2" placeholder="Subtitle text 2" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Subtitle 2</label>
            <v-text-field class="field-input" v-model="subtitle2" id="subtitle2" placeholder="Subtitle 2" type="text"/>
          </div>
          <div class="name-field">
            <label class="field-label">Subtitle Text</label>
            <v-text-field class="field-input" v-model="subtitleText3" id="subtitleText3" placeholder="Subtitle text" type="text"/>
          </div>
          <div class="name-field">
  ...
  methods: {
    onSubmit() {
      ...
      if(this.title === "" || this.title === null || this.description === "" || this.description === null || 
        ...
        firebase.database().ref('homePost4').push({
          title: this.title,
          description: this.description,
          ...
          subtitleText1: this.subtitleText1,
          subtitleText2: this.subtitleText2,
          subtitle2: this.subtitle2,
          subtitleText3: this.subtitleText3,
          urlText: this.urlText,
          url: this.url,
        })
        .then((data)=>{
    ...
    deleteImpDate(id) {
      console.log(id)
      firebase.database().ref('homePost4/' + id).remove();
    },
    previewImage(event) {
      this.uploadValue=0;
      this.picture=null;
